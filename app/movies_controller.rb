...
def can_be_created_in_a_block(args = {title: "Home Alone", release_date: 1990,
   director: "Bob", lead: "Culkin", in_theaters: false})
...
def can_be_found_updated_and_saved
  ...
  to_update.title = "Even Awesomer Flick"
  to_update.save
  to_update
end
...
def can_destroy_a_single_item
  ...
  to_delte = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  to_delte.destroy
end
